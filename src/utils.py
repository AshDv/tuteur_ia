...
class YouTubeProcessor:
    ...
    def get_transcript_text(video_id: str) -> str | None:
        ...
        try:
            # Appel direct à la méthode statique de la classe importée
            transcript_list = YouTubeTranscriptApi.get_transcript(
                video_id, 
                languages=['fr', 'fr-FR', 'en', 'en-US', 'en-GB']
            )
            ...
            # Affichage de l'erreur brute pour le debug si ça persiste
            st.error(f"Erreur technique YouTube : {e}")
            return None